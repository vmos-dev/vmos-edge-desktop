...
interface IVergeConfig {
  ...
  language?: string
  tray_event?: 'main_window' | 'tray_menu' | 'system_proxy' | 'tun_mode' | string
...
interface ITrafficWorkerSnapshotMessage {
  ...
  reason: 'init' | 'interval' | 'range-change' | 'request' | 'append-throttle' | 'clear'
}
...
type TrafficWorkerResponseMessage = ITrafficWorkerSnapshotMessage | ITrafficWorkerLogMessage
