<template>
  <VmosDialog v-model="visible" title="修改分组" width="350px" @closed="handleClose">
    <el-form
      ref="formRef"
      :model="form"
      :rules="rules"
    ...
    >
      <el-form-item label="分组名称" prop="name">
        <el-input v-model.trim="form.name" placeholder="请输入分组名称" clearable />
      </el-form-item>
    </el-form>
...
const rules = ref({
  name: [
    ...
    { min: 1, max: 20, message: '分组名称长度为1-20个字符', trigger: 'blur' },
    {
